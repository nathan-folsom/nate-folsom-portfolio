...
export function CaseStudy({description, title, topics}: CaseStudyProps) {
    ...
    const render = () => (
        <div id={"case-study"} className="container-fluid d-flex flex-column px-2 px-md-5">
            ...
            <div className="row mx-0 mt-3">
                ...
                {topics.map(t => <TopicCard title={t.title} subtitle={t.subtitle} url={`${route ? route.url : ''}/${t.url}`} key={t.title}/>)}
            </div>
